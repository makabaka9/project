  ...
  const renderContent = () => {
    return (
      <>
        ...
        <FormItem name="trainCode" label="车号" rules={[{ required: true, message: '请输入！' }]}>
        ...
        <FormItem name="content" label="检修内容" rules={[{ required: true, message: '请输入！' }]}>
          <Input placeholder="请输入" />
        </FormItem>
        <FormItem
          name="person"
