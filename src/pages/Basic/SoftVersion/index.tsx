...
const TableList: React.FC<{}> = () => {
  ...
  const columns: ProColumns<TableListItem>[] = [
    ...
    },
    {
      ...
      valueType: 'textarea',
      valueEnum: {
        1: { text: 'TDS', status: 'success' },
        2: { text: 'DCU', status: 'success' },
        3: { text: 'BCU', status: 'success' },
        4: { text: 'HVAC', status: 'success' },
        5: { text: 'SIV', status: 'success' },
        6: { text: 'PDS', status: 'success' },
        7: { text: 'EDCU', status: 'success' },
        8: { text: 'FAS', status: 'success' },
        9: { text: 'PIS', status: 'success' },
        10: { text: 'AODS', status: 'success' },
        11: { text: 'TCMS', status: 'success' },
      },
    },
    {
      title: '软件名称',
    ...
    },
    {
      ...
      render: (_, row: any) => (
        row.status === 0 ?
          <Avatar size={13} src={dotIcon} /> :
          <Avatar size={13} src={dotIcon1} />
      ),
    },
    {
      title: '最近变更时间',
