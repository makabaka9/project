  ...
  const renderContent = () => {
    return (
      <>
        ...
        <FormItem name="local" label="更换位置" rules={[{ required: true, message: '请输入' }]}>
          <Input placeholder="请输入" />
        </FormItem>
        <FormItem name="reason" label="更换原因" rules={[{ required: true, message: '请输入' }]}>
          <Input placeholder="请输入" />
        </FormItem>
        <FormItem
          name="content"
        ...
        <FormItem name="person" label="更换人" rules={[{ required: true, message: '请输入' }]}>
          <Input placeholder="请输入" />
        </FormItem>
        <FormItem name="time" label="更换时间" rules={[{ required: true, message: '请输入' }]}>
          <DatePicker
