...
import { queryDetectorStatus, queryAuxiliaryStatusData, queryFaultPie, queryFaultInfo, queryFaultHistogram } from './service';
...
const Model: ModelType = {
  namespace: 'subsystemAndPyrotechnic',
  ...
  effects: {
    ...
    //   });
    // },
    *fetchDetectorStatus({ payload }, { call, put }) {
      console.log("fetchData");
      const response = yield call(queryDetectorStatus, payload);
      yield put({
        type: 'detectorStatus',
        payload: response,
      });
