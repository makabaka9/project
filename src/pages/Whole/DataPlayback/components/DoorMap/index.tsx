              ...
              renderItem={itemCoach => (
                <List.Item>
                  ...
                  <Card bodyStyle={{
                    ...
                    <Row>
                      <Col span={8}>
                        {itemCoach.lcu2 === 1 ? <Tag color="#52c41a">LCU</Tag> : itemCoach.lcu2 === 0 ? <Tag color="#f5222d">LCU</Tag> : null}
                      </Col>
                      <Col span={8}>
                        <Avatar
                          size="small"
                      ...
                      <Col span={8}>
                        {itemCoach.lcu1 === 1 ? <Tag color="#52c41a" >LCU</Tag> : itemCoach.lcu1 === 0 ? <Tag color="#f5222d">LCU</Tag> : null}
                      </Col>
                    </Row>
